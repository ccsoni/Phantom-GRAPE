...
static PG6::PrdPosVel prdposvel[PG6::NumberOfPipe];
static PG6::NewAccJrk newaccjrk[PG6::NumberOfPipe];
...
#endif
    for(i = 0; i < ni; i += PG6::NumberOfIParallel)
